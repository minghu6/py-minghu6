...
def test_require_vars():
    from minghu6.meta.decorators import require_vars, LackMethodError
...
def test_handle_excpetion():
    import doctest
    from minghu6.meta.decorators import handle_exception
...
def test_mock_func():
    from minghu6.meta.decorators import mock_func
...
def test_singleton():
    from minghu6.meta.decorators import singleton
...
def test_timer():
    from minghu6.meta.decorators import timer
...
def test_to_class():
    from minghu6.meta import decorators

    @decorators.to_class('get_result')
