...
def count_lines_dir(dir, exts=None, ignore_blank=False):
    ...
    for fullpath in find(new_exts, startdir=dir):
        cnt_files += 1
        n += count_lines_file(fullpath, ignore_blank)
...
def shell_interactive():
    ...
    parser.add_argument("-p", "--path", dest="dir", help="searched dir name")
...
def cli():
    ...
    n = count_lines_dir(dir=args.dir, exts=args.exts, ignore_blank=args.ignore_blank)
